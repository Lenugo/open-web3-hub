...
export const mainTopics = ['blockchain', 'web3', 'dapps', 'ai', 'artificial-intelligence', 'machine-learning', 'artificial-neural-network', 'solidity', 'ethereum', 'solana', 'cardano', 'nft', 'cryptocurrency', 'erc-20', 'erc-721', 'smart-contract', 'smart-contract-tools']
